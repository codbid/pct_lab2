...
set style line 4 lc rgb "0xFF0000" lt 1 lw 4 pt 7 ps 1
...
set xrange [2:8]
set format y "%1.4f"
plot "1.dat" using 1:2 title "n = m = 15000" with linespoints ls 1, \
"1.dat" using 1:3 title "n = m = 20000" with linespoints ls 2, \
"1.dat" using 1:4 title "n = m = 25000" with linespoints ls 3, \
